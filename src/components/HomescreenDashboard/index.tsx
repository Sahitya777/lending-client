    ...
    <div className="w-[96%] ml-[2%] min-h-screen bg-[#181818] text-white rounded-md">
      <div className="mx-auto max-w-7xl p-6 lg:p-4">
        ...
        <div className="mt-6 flex justify-between w-full">
          ...
          <div className="flex flex-col gap-3 w-[63.5%]">
            {user && (
                    ...
                    <div className="divide-y divide-emerald-900/30">
                        ...
                        (
                          ...
                          >
                            ...
                            <div className="flex justify-end">
                              <Button className="bg-transparent text-white cursor-pointer border border-[#222222] h-8 px-3 text-xs font-medium">
                                Withdraw
                              </Button>
                            </div>
                            ...
                            {/* Supply button */}
                            <div className="flex justify-end">
                              <Button className="bg-[#0D0D0D] text-white cursor-pointer border border-[#222222] h-8 px-3 text-xs font-medium">
                                Supply
                              </Button>
                            </div>
                          </div>
                      ...
                      <div className="grid grid-cols-7 items-center px-3 py-3 text-sm font-semibold">
                        ...
                        <div className="text-right text-white">
                          ...
                          {merged.lendBorrow.rows
                            .reduce(
                              (a: number, b: { debt: number }) => a + b.debt,
                              0
                            )
                            .toFixed(2)}
                        </div>
                  ...
                  <div className="p-5">
                    ...
                    <div className="divide-y divide-emerald-900/30">
                      {merged.lendBorrow.rows.map(
                        (
                          ...
                          >
                            ...
                            {/* Health */}
                            <div className="text-right text-gray-300">
                              {r.health ? `${r.health.toFixed(2)}%` : "0.00%"}
                            </div>
                      ...
                      <div className="grid grid-cols-8 items-center px-3 py-3 text-sm font-semibold">
                        ...
                        {/* Could total APR, but usually APR isn't summed, so leave blank */}
                        <div />

                        {/* Could total collateral/health, usually N/A to aggregate */}
                        <div />
                        <div />
            ...
            {!user && (
              <div className="rounded-2xl flex items-center p-2 justify-between border border-[#232322] bg-transparent shadow-sm">
                <div className="p-5">
                  <h2 className="text-lg font-semibold text-white">Pools</h2>
                  <p className="text-[11px] uppercase tracking-wide text-gray-500 mt-2">
                    No open deposit yet
                  </p>
                  <p className="text-sm text-gray-300 mt-1 max-w-[300px]">
...
function SummaryPill({ label, value, valueClass }: any) {
  return (
    <div className="flex items-center gap-2">
      <div>
        <div
          className={`text-base font-semibold ${valueClass || "text-white"}`}
        >
          {value}
        </div>
...
function IllustrationCard() {
  return (
    <div className="rounded-2xl border border-dashed border-emerald-900/50 bg-slate-900 p-6">
      <div className="grid grid-cols-2 gap-6 items-center">
        <div className="rounded-2xl bg-slate-800 border border-emerald-900/30 p-6 shadow-sm">
          <div className="h-24 rounded-xl bg-gradient-to-br from-slate-700 to-slate-800"></div>
        </div>
        <div className="rounded-2xl bg-slate-800 border border-emerald-900/30 p-6 shadow-sm">
          <div className="h-24 rounded-xl bg-gradient-to-br from-slate-700 to-slate-800"></div>
        </div>
