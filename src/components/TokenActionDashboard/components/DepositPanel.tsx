...
export default function  DepositPanel({lastSegment}:{lastSegment:string |undefined}) {
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-3 rounded-xl border bg-background px-3 py-3">
            <div className="flex items-center gap-2 rounded-lg bg-muted px-3 py-2">
              {icon ?<Image src={icon} alt={"logo"} height={18} width={18} />:<div className="h-4 w-4 rounded-full bg-indigo-600" />}
